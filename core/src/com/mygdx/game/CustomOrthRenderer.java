...
public class CustomOrthRenderer extends BatchTiledMapRenderer {

	public CustomOrthRenderer (TiledMap map) {
		super(map);
	}

	public CustomOrthRenderer (TiledMap map, Batch batch) {
		super(map, batch);
	}

	public CustomOrthRenderer (TiledMap map, float unitScale) {
		super(map, unitScale);
	}

	public CustomOrthRenderer (TiledMap map, float unitScale, Batch batch) {
